...
asm_main:
        ...
        call    print_string      ; print ptompt

        call    read_int          ; get int from user
        mov     [input], eax      ; save user input in [input]

        imul    eax               ; edx:eax = eax * eax (this is the user input squared)
        mov     ebx, eax          ; save answer in ebx
        mov     eax, square_msg   ; setup sqaure message
        call    print_string      ; print square message
        mov     eax, ebx          ; eax = ebx
        call    print_int         ; print sqaured number
        call    print_nl          ; print a newline

        mov     ebx, eax          ; ebx = eax (squared)
        imul    ebx, [input]      ; ebx *= [input] (cubed)
        mov     eax, cube_msg     ; setup cube message
        call    print_string      ; print cube message
        mov     eax, ebx          ; eax = ebx (the number cubed)
        call    print_int         ; print number cubed
